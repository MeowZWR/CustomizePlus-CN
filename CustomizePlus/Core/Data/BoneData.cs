...
public static class BoneData //todo: DI, do not show IVCS unless IVCS is installed/user enabled it, do not show weapon bones
{
    ...
    private static readonly string[] BoneRawTable =
    {
        ...
        "butt_l,左臀（Skelomae）,Jiggle,FALSE,TRUE,j_kosi,butt_r",
        "butt_r,右臀（Skelomae）,Jiggle,FALSE,TRUE,j_kosi,butt_l",
        "thigh_l,左腿（Skelomae）,Jiggle,FALSE,TRUE,j_asi_a_l,thigh_r",
        "thigh_r,右腿（Skelomae）,Jiggle,FALSE,TRUE,j_asi_a_r,thigh_l",
        "forebreas_l,左乳尖（Skelomae）,Jiggle,FALSE,TRUE,j_mune_l,forebreas_r",
        "forebreas_r,右乳尖（Skelomae）,Jiggle,FALSE,TRUE,j_mune_r,forebreas_l",
        "belly_sebo_a,上腹（Skelomae）,Jiggle,FALSE,TRUE,j_sebo_a,",
        "belly_kosi,下腹（Skelomae）,Jiggle,FALSE,TRUE,j_kosi,",
        "ya_shiri_phys_l,左臀（YAS）,Jiggle,FALSE,TRUE,j_kosi,ya_shiri_phys_r",
        "ya_shiri_phys_r,右臀（YAS）,Jiggle,FALSE,TRUE,j_kosi,ya_shiri_phys_l",
        "ya_daitai_phys_l,左腿（YAS）,Jiggle,FALSE,TRUE,j_kosi,ya_daitai_phys_r",
        "ya_daitai_phys_r,右腿（YAS）,Jiggle,FALSE,TRUE,j_kosi,ya_daitai_phys_l",
        "iv_fukubu_phys,上腹（YAS）,Jiggle,FALSE,TRUE,j_kosi,",
        "ya_fukubu_phys,下腹（YAS）,Jiggle,FALSE,TRUE,j_kosi,",

        "pifeng_a_l,左臂披风 A,Meowz,FALSE,FALSE,j_ude_a_l,pifeng_a_r",
        "pifeng_a_r,右臂披风 A,Meowz,FALSE,FALSE,j_ude_a_r,pifeng_a_l",
        "pifeng_b_l,左臂披风 B,Meowz,FALSE,FALSE,pifeng_a_l,pifeng_b_r",
        "pifeng_b_r,右臂披风 B,Meowz,FALSE,FALSE,pifeng_a_r,pifeng_b_l",
        "pifeng_c_l,左臂披风 C,Meowz,FALSE,FALSE,j_ude_b_l,pifeng_c_r",
        "pifeng_c_r,右臂披风 C,Meowz,FALSE,FALSE,j_ude_b_r,pifeng_c_l",
        "pifeng_d_l,左臂披风 D,Meowz,FALSE,FALSE,j_ude_c_l,pifeng_d_r",
        ...
        "j_toushi_a_l,左头饰 A,Meowz,FALSE,FALSE,j_kao,j_toushi_a_r",
        "j_toushi_a_r,右头饰 A,Meowz,FALSE,FALSE,j_kao,j_toushi_a_l",
        "j_toushi_b_l,左头饰 B,Meowz,FALSE,FALSE,j_kao,j_toushi_b_r",
        "j_toushi_b_r,右头饰 B,Meowz,FALSE,FALSE,j_kao,j_toushi_b_l",
        "j_toushi_c_l,左头饰 C,Meowz,FALSE,FALSE,j_kao,j_toushi_c_r",
        "j_toushi_c_r,右头饰 C,Meowz,FALSE,FALSE,j_kao,j_toushi_c_l",
        "j_toushi_d_l,左头饰 D,Meowz,FALSE,FALSE,j_kao,j_toushi_d_r",
        "j_toushi_d_r,右头饰 D,Meowz,FALSE,FALSE,j_kao,j_toushi_d_l",
        ...
        "j_succu_eyeacc_r,魅魔宝宝右眼角爱心,Meowz,FALSE,FALSE,j_kao,",
    };
